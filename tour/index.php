...
<div class="relative bgded" style="background-image:url('images/demo/backgrounds/04.png'); height :700px">
        ...
        <ul class="clear">
          ...
          <li><a class="drop" href="#">Services</a>
            <ul>
              ...
              <li><a href="user/user-history">History</a>
              </li>
  ...
  <div id = "modal-bg">
		...
		<div class = "form">
			...
			<div class="form-1" style = "height:480px;width:700px">
				<div class = "form-2" >
				<button id="close" style = "height:40px;width:40px; decoration: none; border-radius:40px; font-size: 15px; text-align:center; background: rgba(50,150,50,.90); margin-left:620px; margin-top:0; color: white; text-align:center">x</button>
					<fieldset>
					<form action = "admin/try.php" method = "POST">
			...
			<p style = "margin-left:350px; color:white; font-size:60px; margin-top:80px">Holiday &amp; Travel</p>
			
		
        <p style = " font-size:30px; font-family:sans-serif; margin-left:350px ;color:white ; margin-bottom:80px">You deserve a wanderlust.</p>
		
		<input type="search" results=5 autosave = "search" style = "margin-left:320px" id="search" placeholder="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Find a place to get lost."/>
      <!-- ################################################################################################ -->
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <!-- ################################################################################################ -->
	<!--<p style = "margin-left:350px; font-size:30px; margin-top:9px" > It is not how much we have, but how much we enjoy, that makes happiness</p>-->
    <p style = "margin-left:350px; font-size:30px; margin-top:9px" > Packages!!</p>
	<ul id="home" class="nospace group elements">
	  <li class="one_third first">
        <figure class="elementwrapper"><a class="imgoverlay" href="#login-footer"><img src="images/demo/480x285.png" alt=""></a>
...
<div class="wrapper row5">
  <section id="holtypes" class="hoc clear"> 
    ...
    <ul class="nospace group">
      <li class="one_third first">
        <article><a class="btn" href="http://robbreport.com/luxury-travel/slideshow/top-21-destinations-2016-slideshow/cape-winelands"><i class="tr tr-golf22"></i></a>
          <h4 class="heading">Luxury</h4>
          <p>Visit the most luxurious places around the world.</p>
        </article>
      </li>
      <li class="one_third">
        <article><a class="btn" href="http://trak.in/tags/business/2010/04/19/top-10-ten-tourist-attractions-destinations-india/"><i class="tr tr-watercraft"></i></a>
          <h4 class="heading">Domestic Love</h4>
          <p>Explore the incredible India.</p>
        </article>
      </li>
      <li class="one_third">
        <article><a class="btn" href="https://www.beach-inspector.com/en/"><i class="tr tr-person205"></i></a>
        ...
        <article class="elementwrapper">
          ...
          <div class="elementinfo">
            ...
            <ul class="meta">
              ...
              <li><a href="#login-footer">Book &raquo;</a></li>
            </ul>
          </div>
        </article>
      </li>
...
<div class="wrapper coloured">
  <div id="newsletter" class="hoc clear"> 
	...
	<div id="login-footer">
    <form class = "three_quarter" action = "user/try.php" method = "POST">
      <div class="clear">

...
<div class="relative bgded" style="background-image:url('../images/demo/backgrounds/05.png'); height:650px">
  ...
  <div id = "modal-bg">
      ...
      <!-- ################################################################################################ -->
	  <p style = "margin-left:350px; color:aqua; font-size:60px; margin-top:80px">Holiday &amp; Travel</p>
			
		
       <!-- <p style = " font-size:30px; font-family:sans-serif; margin-left:350px ;color:black ; margin-bottom:120px">You deserve a wanderlust.</p>-->
		<form action = "search.php" method = "post">
		<input type="search" results=5 autosave = "search" name="search" style = "margin-left:320px" id="search" placeholder="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Find a place to get lost."/>
		</form>
     </div>
  <div class="wrapper">
        <p style = "margin-bottom:20px; margin-left:200px; font-size:30px; font-family:sans-serif">Book Tickets here!!</p>
<div >
	<form action = "../train/tick.php" style = "background-color:magna" method = "POST">
						...
						<input type = "date" style = "margin-left:500px" id ="search" placeholder = "&nbsp;&nbsp;&nbsp; Date" name = "date" required />
...
<div class="wrapper row3"> 
  <main class="hoc container clear"> 
    <!-- main body -->
    <!-- ################################################################################################ -->
	<h3 style = "margin-left:100px">Packages</h3>
        ...
        <article class="elementwrapper">
          ...
          <div class="elementinfo">
            ...
            <ul class="meta">
			  ...
			  <form action = "../package/vizag.php" method = "POST">
      ...
      <li class="one_third">
        <article class="elementwrapper">
          ...
          <div class="elementinfo">
			...
			<form action = "../package/udai.php" method = "POST">
				<input type ="text" class = "meta" placeholder= "&nbsp &nbsp FROM"> 
				<a href="../Transaction/index.html">Book &raquo;</a>
			</form>

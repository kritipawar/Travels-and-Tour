		...
		<div class = "form">
			<div class="form-1">
				...
				<form action ="cancelbook.php" method = "POST">
					...
					<input type = "radio" class ="inputuser" name = "selectcancel" value = "Package" />Cancel Package
						<input type = "radio" class ="inputuser" name = "selectcancel" value = "Ticket" />Cancel Ticket
						<input type = "text" class ="inputuser" name = "Transaction" placeholder = "Enter Transaction ID" />
					<!--</form>-->

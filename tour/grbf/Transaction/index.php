...
<div class="container">
  <div id="Checkout" class="inline">
      ...
      <form action = "../package/transaction.php?ticket1=<?php echo $A; ?>&others=<?php echo $B; ?>&place=<?php echo $place; ?>&toplace=<?php echo $toplace ?>" method = "POST">
          ...
          <button id="PayButton" type="submit">
              <span class="align-middle">Pay <?php echo $A+$B;?> </span>
          </button>
      </form>
  </div>
</div>

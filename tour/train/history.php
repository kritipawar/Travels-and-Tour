			...
			<div class="form-1">
				...
				<div class = "form-2">
					...
					<input type = "text" class ="inputuser" placeholder = " Transaction number: <?php echo $number;?>" readonly/>
						...
						<input type = "submit" class ="register" value = "Back" style = "background:rgba(0,150,0,.5); color:white; width:100%; height:40px; border: 1px solid green; margin-top: 10px; cursor:pointer; color: black" />	
					</form>
				</div>
			</div>
		</div>	
